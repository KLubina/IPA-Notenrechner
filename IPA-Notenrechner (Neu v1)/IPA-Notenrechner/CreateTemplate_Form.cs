  ...
  public partial class CreateTemplate_Form: Form
    ...
    private void buttonSaveTemplate_Click( object sender_Variable, EventArgs e_Variable )
      ...
      try
        ...
        string connectionString_Variable = "Host=db.hdrnnsfnmxpdhfxbnnzj.supabase.co;Port=5432;Username=postgres;Password=[123Altstetten2000];Database=postgres";

        DatabaseConnector_Class dbConnector_Object = new DatabaseConnector_Class( connectionString_Variable );
        dbConnector_Object.SpeichereTemplate( newTemplate_Variable );

        MessageBox.Show( "Template erfolgreich in die Datenbank gespeichert!", "Erfolg", MessageBoxButtons.OK, MessageBoxIcon.Information );
